 ...
 * @uses ArticleDto: Được dùng để chuyển dữ liệu qua các lớp. 
 * 		Các lớp NewsBlo,NewsDao,News ở Controller và View muốn liên lạc được với nhau phải thông qua lớp ArticleDto này
 */
